...
<a href="/" class="auth-brand-corner" style="position: absolute; top: 20px; left: 25px; z-index: 10; display: inline-flex; align-items: center; text-decoration: none; cursor: pointer; transition: all 0.3s ease;">
