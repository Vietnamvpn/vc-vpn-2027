...
<div style="margin-bottom: 1.25rem;">
    <h1 style="font-size: 1.6rem; font-weight: 700; letter-spacing: -0.5px;">Chỉnh Sửa: <?= htmlspecialchars($plan['name'] ?? '') ?></h1>
</div>
...
<div class="glass-card" style="padding: 1.75rem; width: 100%;">
    <form method="POST" action="/admin/plans/edit?id=<?= $plan['id'] ?>" style="display: flex; flex-direction: column; gap: 1.25rem;">
        ...
        <div>
            ...
            <select id="status" name="status" class="glass-input" style="width: 100%; cursor: pointer;">
                ...
                <option value="inactive" <?= ($plan['status'] ?? '') === 'inactive' ? 'selected' : '' ?>>Inactive (Khóa)</option>
            </select>
        </div>
