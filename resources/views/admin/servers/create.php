...
<div style="margin-bottom: 1.25rem;">
    <h1 style="font-size: 1.6rem; font-weight: 700; letter-spacing: -0.5px;">Thêm Máy Chủ Mới</h1>
</div>
    ...
    <form action="/admin/servers/create" method="POST" style="display: flex; flex-direction: column; gap: 1.25rem;">
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1.25rem;">
            <div>
                ...
                <input type="text" id="name" name="name" class="glass-input" required placeholder="Ví dụ: SG-VIP-Node-01" autofocus style="width: 100%;">
            </div>
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1.25rem;">
            <div>
                ...
                <input type="text" id="country_code" name="country_code" class="glass-input" placeholder="VN, SG, JP, US..." maxlength="10" required style="width: 100%; text-transform: uppercase;">
            </div>

            <div>
                <label style="display: block; font-weight: 600; font-size: 0.85rem; margin-bottom: 0.4rem;">Vị Trí (Location) (*)</label>
                <input type="text" id="location" name="location" class="glass-input" placeholder="Ví dụ: Singapore, Hồ Chí Minh" required style="width: 100%;">
            </div>
        </div>
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1.25rem;">
            <div>
                ...
                <input type="text" id="ip_address" name="ip_address" class="glass-input" placeholder="103.x.x.x" required style="width: 100%;">
            </div>

            <div>
                <label style="display: block; font-weight: 600; font-size: 0.85rem; margin-bottom: 0.4rem;">Cổng API (API Port)</label>
                <input type="number" id="api_port" name="api_port" class="glass-input" value="80" required style="width: 100%;">
            </div>
        ...
        <div style="display: flex; justify-content: flex-end; margin-top: 0.5rem;">
            <button type="submit" class="glass-btn" style="padding: 0.65rem 1.75rem; font-size: 0.9rem;">💾 Lưu Máy Chủ</button>
        </div>
    </form>
</div>
