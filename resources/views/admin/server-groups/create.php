...
<div class="glass-card" style="padding: 1.5rem; max-width: 600px;">
    <form action="/admin/server-groups/create" method="POST" style="display: flex; flex-direction: column; gap: 1.25rem;">
        ...
        <div style="display: flex; gap: 1rem; margin-top: 0.5rem;">
            <button type="submit" class="glass-btn" style="padding: 0.75rem 1.5rem; font-weight: 600; background: var(--ios-blue); color: #fff; border: none; cursor: pointer;">Lưu Nhóm</button>
